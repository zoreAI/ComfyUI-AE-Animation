...
class AEAnimationCore(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                io.Int.Input("width", default=1920, min=64, max=8192),
                io.Int.Input("height", default=1080, min=64, max=8192),
                io.Int.Input("fps", default=30, min=1, max=120),
                io.Int.Input("total_frames", default=150, min=1, max=9999),
            ...
            outputs=[io.String.Output("animation")],
        )
    ...
    def execute(
        ...
        return io.NodeOutput(json.dumps(final_animation))
